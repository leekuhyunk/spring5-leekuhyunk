        ...
        <div class="row"><!-- 부트스트랩의 디자인 클래스 row -->
              ...
              <!-- /.card-header -->
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <!-- html5에서 지원되는 유효성검사 maxlength.required,type="email-->
                    <!-- html5지원 브라우저에서만 사용가능 그래서, jquery.validator라는 자바스크립트를 사용  -->
                    <input maxlegth="10" minlength="5" value="" type="password" class="form-control" name="user_pw" id="user_pw" placeholder="암호를 입력해 주세요.">
                  </div>
                  <div class="form-group">
          ...
          <!-- 버튼영역 시작 -->
            <div class="card-body">
            	...
            	<a href="/admin/member/member_list?page=${pageVO.page}&user_id=${memberVO.user_id}" class="btn btn-info float-right mr-1">뒤로가기</a>

<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<!-- html주석시작  jsp: JavaSeverPage 자바서버용페이지 -->
<%--자바주석시작  하이픈(-)
- jsp에서 자바프로그램을 사용할 때 쓰는 태그 <% %> 감사주게 됩니다.
- 다른언어 PHP예를 들면 <?php ?>로 감싸주게 됩니다. 
- @ page골뱅이는 애노테이션-페이지지시자 랭귀지:java,
- 콘텐츠타입:text/html;문자셋:유티코드 페이지인코딩:UTF-8
자바주석 끝 --%>
...
- MVC = Model(데이터베이스) - View(jsp페이지) - Controller(컨트롤러 java클래스)<br>

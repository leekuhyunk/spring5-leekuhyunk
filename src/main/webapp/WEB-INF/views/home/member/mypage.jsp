				...
				<fieldset>
					...
					<ul class="app_list">
						...
						<li class="clear">
							...
							<div class="app_content radio_area">
								<input <c:out value="${(memberVO.enabled eq 'true')?'checked':''}" /> disabled type="radio" name="enabled" class="css-radio" id="enabled_lbl" />
								<label for="enabled_lbl">회원사용</label>
								<input <c:out value="${(memberVO.enabled eq 'false')?'checked':''}" /> disabled type="radio" name="enabled" class="css-radio" id="disabled_lbl"  />

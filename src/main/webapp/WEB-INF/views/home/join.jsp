...
jQuery(document).ready(function(){ 
	...
	jQuery("input[name='user_id']").bind("blur",function(){
		//불러 blur이벤트는 focus선택과는 반대이벤트=선택을 벗어났을때 이벤트
		...
		jQuery.ajax({
			...
			success:function(result){
				...
				if(result=='1'){
					alert('중복 아이디가 존재 합니다. 다시입력 해주세요');
...
jQuery(document).ready(function(){
	jQuery("form[name='join_form']").on("submit",function(){

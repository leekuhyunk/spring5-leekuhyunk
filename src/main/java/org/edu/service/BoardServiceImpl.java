...
public class BoardServiceImpl implements IF_BoardService {
	...
	public void insertBoard(BoardVO boardVO) throws Exception {
		...
		for(String save_file_name:save_file_names) {//첨부파일 1개일때는 1번만
	...
	public void updateBoard(BoardVO boardVO) throws Exception {
		...
		// 첨부파일 등록DAO연결(아래) 조건은 기존 첨부파일 DB를 삭제한 이후
		...
		for(String save_file_name:save_file_names) {//첨부파일 개수 만큼 반복됩니다.
			//System.out.println("디버그" +index+"번쨰 실행" + save_file_names[index]);

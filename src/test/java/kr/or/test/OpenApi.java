...
public class OpenApi {
	...
	public static void serviceApi() {
		...
		try {
			...
			//콘솔화면에 현재 PC시간을 표시해서 진짜 5초단위로 작동되는지 스케줄대로 작동되는지 확인
	...
	public static void main(String[] args) {
		...
		int sleepSec = 10;
		//주기적인 스레드작업(Concurrent동시작업)을위한 코딩 변수 new 키워드로 실행가능한 오브젝트 변수인 exec변수 생성.
...
class StaticTest {//스태틱은 메서드, 변수에도 해당되는 이론
	public static void test() {//스태틱은 메모리 기준으로 고정메모리를 할당받음=실행가능
